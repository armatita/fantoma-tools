...
Components and wires now pick their colour from the same fifteen-colour palette
the model viewer offers — copied into the page, not read from the model
viewer's manifest, because that file is generated by Fantoma.
